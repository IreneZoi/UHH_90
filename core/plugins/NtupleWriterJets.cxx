...
void NtupleWriterTopJets::process(const edm::Event & event, uhh2::Event & uevent, const edm::EventSetup& iSetup){
	...
	if(!njettiness_groomed_src.empty()){
        ...
        if(njettiness_src.empty()){
          ...
          topjet.set_tau1(pat_topjet.userFloat("ak8PFJetsCHSValueMap:NjettinessAK8CHSTau1"));
          topjet.set_tau2(pat_topjet.userFloat("ak8PFJetsCHSValueMap:NjettinessAK8CHSTau2"));
          topjet.set_tau3(pat_topjet.userFloat("ak8PFJetsCHSValueMap:NjettinessAK8CHSTau3"));
        }
	if(njettiness_groomed_src.empty()){
